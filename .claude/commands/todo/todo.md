---
name: todo
description: Manage project todos in todos.md file with comprehensive task tracking
---

# How to manage project todos

Please manage todos for: $ARGUMENTS.

Follow this systematic approach to manage todos in a `todos.md` file at the root of your current project directory:
