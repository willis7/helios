---
description: Capture and document session learnings for future reference
---

# How to capture and document session learnings

Please capture and document session learnings for: $ARGUMENTS.
